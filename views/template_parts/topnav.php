...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <!-- Nav Item - Alerts -->
        <?php if(count($userNotices) > 0): ?>
        <li class="nav-item dropdown no-arrow mx-1">
            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button"
               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <i class="fas fa-bell fa-fw"></i>
                <!-- Counter - Alerts -->
                <span class="badge badge-danger badge-counter"><?= count($userNotices); ?></span>
            </a>
            <!-- Dropdown - Alerts -->
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                    ...
                    <div>
                        <div class="small text-gray-500"><?= $userNotice->getDateCreated(); ?></div>
        ...
        <li class="nav-item dropdown no-arrow mx-1">
            <a class="nav-link dropdown-toggle" href="#" id="messagesDropdown" role="button"
               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <!-- Counter - Messages -->
                <span class="badge badge-danger badge-counter"><?= count($userMessages); ?></span>
            </a>
            <!-- Dropdown - Messages -->
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <?php
                $fromUser = $userMessage->getFromUser();
                ?>
                <a class="dropdown-item d-flex align-items-center" href="#">
                    ...
                    <div <?php if($userMessage->getStatus() === "UNREAD"): ?> class="font-weight-bold" <?php endif; ?>>
                        <div class="text-truncate"><?= $userMessage->getSubject(); ?></div>
                        <div class="small text-gray-500"><?= $fromUser->getUserName(); ?> · 58m</div>
                    </div>
                </a>
                <?php endforeach; ?>

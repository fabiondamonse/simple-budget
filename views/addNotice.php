                ...
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form method="post" enctype="multipart/form-data" name="task_form" id="task_form" autocomplete="off" action="/addNotice">

                                    <div class="mb-3">
                                        <label class="small mb-1" for="txtNoticeName">Notice Name</label>
                                        <input class="form-control" id="txtNoticeName" name="name" type="text" placeholder="Enter your username" value="">
                                    </div>

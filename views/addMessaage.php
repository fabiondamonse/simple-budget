                ...
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form method="post" enctype="multipart/form-data" name="task_form" id="task_form" autocomplete="off" action="/addMessage">

                                    <div class="mb-3">
                                        <label class="small mb-1" for="txtNoticeName">Subject</label>
                                        <input class="form-control" id="txtSubject" name="subject" type="text" placeholder="Enter your subject" value="">
                                    </div>

                                    <div class="mb-3">
                                        <label class="small mb-1" for="txtNoticeMessage">Message</label>
                                        <textarea class="form-control" rows="5" id="txtNoticeMessage" name="message"></textarea>
                                    </div>
